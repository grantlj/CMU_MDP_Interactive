Packaging and Deploying mdp_interactive_test
...
2. Installing the mdp_interactive_test Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   mdp_interactive_test. If you do not have write permissions, copy all its contents to a 
...
3. Using the mdp_interactive_test Package

The mdp_interactive_test package is on your Python path. To import it into a Python 
