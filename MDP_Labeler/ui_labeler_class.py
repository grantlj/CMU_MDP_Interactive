...
""))
        ...
        self.label_iteration.setGeometry(QtCore.QRect(1000, 80, 451, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btn_update.setGeometry(QtCore.QRect(1050, 820, 93, 41))
        ...
        self.btn_save_result.setGeometry(QtCore.QRect(1170, 820, 93, 41))
        ...
        self.btn_out_video.setGeometry(QtCore.QRect(1290, 820, 93, 41))
        self.btn_out_video.setObjectName(_fromUtf8("btn_out_video"))
        self.btn_do_track = QtGui.QPushButton(self.centralwidget)
        self.btn_do_track.setEnabled(False)
        self.btn_do_track.setGeometry(QtCore.QRect(930, 820, 93, 41))
        self.btn_do_track.setObjectName(_fromUtf8("btn_do_track"))
    ...
    def retranslateUi(self, MDPLabler):
        ...
        self.btn_do_track.setText(_translate("MDPLabler", "Track", None))
